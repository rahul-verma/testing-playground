...
- **Integration & data handling**
  - Wrong backend system called
  - Incorrect parameters in API calls
  - Stale / cached data issues
  - Idempotency & duplicate actions
  - Transactionality & rollback failure
  - AuthN/AuthZ bugs

- **Internationalization & regional logic**
  - Locale / language mismatch
  - Jurisdiction / regional rule bugs
  - Multi-currency & unit handling bugs

- **ML / prompting**
  - Training data coverage bugs
  - Prompt / instruction design bugs
  - Bias & fairness bugs
  - Drift & environment mismatch bugs

- **Observability / metrics**
  - Metrics miscalculation & attribution bugs
