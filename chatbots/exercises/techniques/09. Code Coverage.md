...
Here’s a self-contained, deep exercise built around **one Python function** in the Parloa-style context, touching:
...
### Part 4 – Path Coverage (with Realistic Constraints)
...
### Part 5 – Loop Coverage on the Risk Calculation
