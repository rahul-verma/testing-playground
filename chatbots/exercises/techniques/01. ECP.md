...
For invalid values, as we can't be sure whether the other values were processed at all, so in such a case we can not consider them under parition coverage.
